...
func dae_configlexerLexerInit() {
	...
	staticData.serializedATN = []int32{
		...
		9, 56, 1, 0, 0, 0, 11, 58, 1, 0, 0, 0, 13, 60, 1, 0, 0, 0, 15, 62, 1, 0,
		0, 0, 17, 64, 1, 0, 0, 0, 19, 66, 1, 0, 0, 0, 21, 68, 1, 0, 0, 0, 23, 71,
		...
		45, 158, 1, 0, 0, 0, 47, 48, 5, 123, 0, 0, 48, 2, 1, 0, 0, 0, 49, 50, 5,
		125, 0, 0, 50, 4, 1, 0, 0, 0, 51, 52, 5, 58, 0, 0, 52, 6, 1, 0, 0, 0, 53,
		54, 5, 38, 0, 0, 54, 55, 5, 38, 0, 0, 55, 8, 1, 0, 0, 0, 56, 57, 5, 44,
		0, 0, 57, 10, 1, 0, 0, 0, 58, 59, 5, 91, 0, 0, 59, 12, 1, 0, 0, 0, 60,
		61, 5, 93, 0, 0, 61, 14, 1, 0, 0, 0, 62, 63, 5, 33, 0, 0, 63, 16, 1, 0,
		0, 0, 64, 65, 5, 40, 0, 0, 65, 18, 1, 0, 0, 0, 66, 67, 5, 41, 0, 0, 67,
		20, 1, 0, 0, 0, 68, 69, 5, 45, 0, 0, 69, 70, 5, 62, 0, 0, 70, 22, 1, 0,
		0, 0, 71, 72, 7, 0, 0, 0, 72, 24, 1, 0, 0, 0, 73, 74, 7, 1, 0, 0, 74, 26,
		1, 0, 0, 0, 75, 76, 7, 2, 0, 0, 76, 28, 1, 0, 0, 0, 77, 81, 3, 23, 11,
		0, 78, 81, 3, 25, 12, 0, 79, 81, 3, 27, 13, 0, 80, 77, 1, 0, 0, 0, 80,
		78, 1, 0, 0, 0, 80, 79, 1, 0, 0, 0, 81, 30, 1, 0, 0, 0, 82, 88, 5, 34,
		0, 0, 83, 84, 5, 92, 0, 0, 84, 87, 5, 34, 0, 0, 85, 87, 9, 0, 0, 0, 86,
		83, 1, 0, 0, 0, 86, 85, 1, 0, 0, 0, 87, 90, 1, 0, 0, 0, 88, 89, 1, 0, 0,
		0, 88, 86, 1, 0, 0, 0, 89, 91, 1, 0, 0, 0, 90, 88, 1, 0, 0, 0, 91, 92,
		5, 34, 0, 0, 92, 32, 1, 0, 0, 0, 93, 99, 5, 39, 0, 0, 94, 95, 5, 92, 0,
		0, 95, 98, 5, 39, 0, 0, 96, 98, 9, 0, 0, 0, 97, 94, 1, 0, 0, 0, 97, 96,
		1, 0, 0, 0, 98, 101, 1, 0, 0, 0, 99, 100, 1, 0, 0, 0, 99, 97, 1, 0, 0,
		0, 100, 102, 1, 0, 0, 0, 101, 99, 1, 0, 0, 0, 102, 103, 5, 39, 0, 0, 103,
		34, 1, 0, 0, 0, 104, 106, 7, 3, 0, 0, 105, 104, 1, 0, 0, 0, 106, 107, 1,
		0, 0, 0, 107, 105, 1, 0, 0, 0, 107, 108, 1, 0, 0, 0, 108, 109, 1, 0, 0,
		0, 109, 110, 6, 17, 0, 0, 110, 36, 1, 0, 0, 0, 111, 112, 5, 47, 0, 0, 112,
		113, 5, 42, 0, 0, 113, 117, 1, 0, 0, 0, 114, 116, 9, 0, 0, 0, 115, 114,
		1, 0, 0, 0, 116, 119, 1, 0, 0, 0, 117, 118, 1, 0, 0, 0, 117, 115, 1, 0,
		0, 0, 118, 120, 1, 0, 0, 0, 119, 117, 1, 0, 0, 0, 120, 121, 5, 42, 0, 0,
		121, 122, 5, 47, 0, 0, 122, 123, 1, 0, 0, 0, 123, 124, 6, 18, 0, 0, 124,
		38, 1, 0, 0, 0, 125, 129, 5, 35, 0, 0, 126, 128, 9, 0, 0, 0, 127, 126,
		1, 0, 0, 0, 128, 131, 1, 0, 0, 0, 129, 130, 1, 0, 0, 0, 129, 127, 1, 0,
		0, 0, 130, 138, 1, 0, 0, 0, 131, 129, 1, 0, 0, 0, 132, 134, 7, 4, 0, 0,
		133, 132, 1, 0, 0, 0, 134, 135, 1, 0, 0, 0, 135, 133, 1, 0, 0, 0, 135,
		136, 1, 0, 0, 0, 136, 139, 1, 0, 0, 0, 137, 139, 5, 0, 0, 1, 138, 133,
		1, 0, 0, 0, 138, 137, 1, 0, 0, 0, 139, 140, 1, 0, 0, 0, 140, 141, 6, 19,
		0, 0, 141, 40, 1, 0, 0, 0, 142, 146, 3, 23, 11, 0, 143, 145, 3, 29, 14,
		0, 144, 143, 1, 0, 0, 0, 145, 148, 1, 0, 0, 0, 146, 144, 1, 0, 0, 0, 146,
		147, 1, 0, 0, 0, 147, 42, 1, 0, 0, 0, 148, 146, 1, 0, 0, 0, 149, 153, 3,
		25, 12, 0, 150, 152, 3, 29, 14, 0, 151, 150, 1, 0, 0, 0, 152, 155, 1, 0,
		0, 0, 153, 151, 1, 0, 0, 0, 153, 154, 1, 0, 0, 0, 154, 44, 1, 0, 0, 0,
		155, 153, 1, 0, 0, 0, 156, 159, 3, 31, 15, 0, 157, 159, 3, 33, 16, 0, 158,
		156, 1, 0, 0, 0, 158, 157, 1, 0, 0, 0, 159, 46, 1, 0, 0, 0, 14, 0, 80,
		86, 88, 97, 99, 107, 117, 129, 135, 138, 146, 153, 158, 1, 6, 0, 0,
	}
